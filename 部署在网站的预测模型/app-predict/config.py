...
def arg_parse():
    ...
    arg_parser.add_argument('--learning_rate', type=float, default=1e-4, help='the learning rate of network')
    arg_parser.add_argument('--weight_decay', type=float, default=1e-6, help='the weight decay rate of network')
